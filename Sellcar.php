...
<figure>
      <img src="use.jpg" alt="">
      <div class="parent">
        <br><button type="button" class="btn btn-info btn-lg" ><strong>&nbsp&nbsp&nbsp&nbsp&nbspWANT To .....&nbsp&nbsp&nbsp&nbsp&nbsp </strong></a></button>
        <div class="child">
        </div>
        <br><button type="button" class="btn btn-dark btn-lg" ><a href="http://localhost/WT/Addcar.php" ><strong>ADD CAR</strong></a></button>
        <br><button type="button" class="btn btn-dark btn-lg" ><a href="http://localhost/WT/Deletecar.php" ><strong>DELETE CAR</strong></a></button>
    </div>
</figure>
