<?php
  ...
  $query = "SELECT * FROM recent_login ORDER BY id LIMIT 1";
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container1">
        ...
        <form action="deleteusecar.php" method="post">
          <label for="lname">Carname</label>
          <input type="text" id="" name=" carname" placeholder="" required>
          <label for="lname">Car number</label>
          <input type="text" id="" name="car_no" placeholder="" required>
  <br>
  <br>
