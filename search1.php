...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark  bg-dark nav justify-content-end ">
      ...
      <figure>
      <img src="search1.jpg" alt="">
      <div class="parent">
        <div class="input-group">
      <button type="submit" class="btn btn-dark" name="all"><a href="http://localhost/WT/used_search.php">All Used Car</a></button>
    </div>
    ...
    <br>
    <div class="input-group">
      <button type="submit" class="btn btn-dark" name="brand">By Brand</button>
    </div>
    <br>
    <div class="input-group">
      <button type="submit" class="btn btn-dark" name="category">By Category</button>
    </div>
  </form>
</div>
</figure>
