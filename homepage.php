...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark  bg-dark nav justify-content-end ">
          ...
          <ul class="nav justify-content-center">
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                  <a class="nav-link active " aria-current="page" href="http://localhost/WT/homepage.html"> Home </a>
      ...
      <img src="16k.jpg" alt="">
      <div class="parent">
        <h2>SEE ALL USED CARS</h2>
        <div class="child">
        </div>
        <br><button type="button" class="btn btn-info" ><a href="http://localhost/WT/used_search.php" >Search</a></button>
    </div>
</figure>
